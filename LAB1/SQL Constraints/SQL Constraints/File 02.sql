...
select * from customers;
INSERT INTO customers (customer_id,customer_age,customer_name) values (10,30,'jub');
insert into customers values (1, 'Bob', 56, '');
insert into customers (customer_id, customer_name, customer_age) values (2, 'Rob', 51);
...
insert into persons values (1,'a','b',17,1000,12);
...
insert into persons values (2, 'Hideyoshi', 'Nagachika', 30, 54000, 790);
insert into persons values (2, 'Hihi', 'Naga', 30, 52000, 790);
